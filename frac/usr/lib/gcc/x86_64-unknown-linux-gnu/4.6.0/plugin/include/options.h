...
#define MASK_VECT8_RETURNS (1 << 21)
#define MASK_VZEROUPPER (1 << 22)
...
enum opt_code
{
  ...
  OPT_fasm = 425,                            /* -fasm */
  OPT_fassert = 426,                         /* -fassert */
  OPT_fassociative_math = 427,               /* -fassociative-math */
  OPT_fassume_compiled = 428,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 429,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 430,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 431,                   /* -fauto-inc-dec */
  OPT_fautomatic = 432,                      /* -fautomatic */
  OPT_faux_classpath = 433,                  /* -faux-classpath */
  OPT_fbackslash = 434,                      /* -fbackslash */
  OPT_fbacktrace = 435,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 436,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 437,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 438,              /* -fbootstrap-classes */
  OPT_fbounds_check = 439,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 440,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 441,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 442,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 443,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 444,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 445,                        /* -fbuiltin */
  OPT_fbuiltin_ = 446,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 447,                    /* -fcall-saved- */
  OPT_fcall_used_ = 448,                     /* -fcall-used- */
  OPT_fcaller_saves = 449,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 450,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 451,                /* -fcheck-data-deps */
  OPT_fcheck_new = 452,                      /* -fcheck-new */
  OPT_fcheck_references = 453,               /* -fcheck-references */
  OPT_fcheck_ = 454,                         /* -fcheck= */
  OPT_fclasspath_ = 455,                     /* -fclasspath= */
  OPT_fcoarray_ = 456,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 457,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 458,                         /* -fcommon */
  OPT_fcompare_debug = 459,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 460,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 461,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 462,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 463,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 464,                  /* -fcond-mismatch */
  OPT_fconserve_space = 465,                 /* -fconserve-space */
  OPT_fconserve_stack = 466,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 467,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 468,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 469,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 470,          /* -fconvert=little-endian */
  OPT_fconvert_native = 471,                 /* -fconvert=native */
  OPT_fconvert_swap = 472,                   /* -fconvert=swap */
  OPT_fcprop_registers = 473,                /* -fcprop-registers */
  OPT_fcray_pointer = 474,                   /* -fcray-pointer */
  OPT_fcrossjumping = 475,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 476,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 477, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 478,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 479,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 480,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 481,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 482,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 483,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 484,                       /* -fdbg-cnt= */
  OPT_fdce = 485,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 486,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 487,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 488,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 489, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 490,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 491,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 492,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 493,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 494,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 495,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 496,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 497,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 498,                /* -fdirectives-only */
  OPT_fdisable_assertions = 499,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 500,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 501,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 502,         /* -fdollars-in-identifiers */
  OPT_fdse = 503,                            /* -fdse */
  OPT_fdump_ = 504,                          /* -fdump- */
  OPT_fdump_core = 505,                      /* -fdump-core */
  OPT_fdump_final_insns = 506,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 507,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 508,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 509,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 510,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 511,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 512,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 513,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 514,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 515,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 516,                 /* -fearly-inlining */
  OPT_felide_constructors = 517,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 518,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 519, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 520,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 521,        /* -femit-class-debug-always */
  OPT_femit_class_file = 522,                /* -femit-class-file */
  OPT_femit_class_files = 523,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 524,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 525,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 526,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 527,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 528,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 529,               /* -fenable-icf-debug */
  OPT_fencoding_ = 530,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 531,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 532, */           /* -fenum-int-equiv */
  OPT_fexceptions = 533,                     /* -fexceptions */
  OPT_fexcess_precision_ = 534,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 535,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 536,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 537,                       /* -fextdirs= */
  OPT_fextended_identifiers = 538,           /* -fextended-identifiers */
  OPT_fexternal_blas = 539,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 540, */       /* -fexternal-templates */
  OPT_ff2c = 541,                            /* -ff2c */
  OPT_ffast_math = 542,                      /* -ffast-math */
  OPT_ffilelist_file = 543,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 544,               /* -ffinite-math-only */
  OPT_ffixed_ = 545,                         /* -ffixed- */
  OPT_ffixed_form = 546,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 547,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 548,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 549,                    /* -ffloat-store */
  OPT_ffor_scope = 550,                      /* -ffor-scope */
  /* OPT_fforce_addr = 551, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 552,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 553,              /* -fforward-propagate */
  OPT_ffp_contract_ = 554,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 555,                      /* -ffpe-trap= */
  OPT_ffree_form = 556,                      /* -ffree-form */
  OPT_ffree_line_length_ = 557,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 558,          /* -ffree-line-length-none */
  OPT_ffreestanding = 559,                   /* -ffreestanding */
  OPT_ffriend_injection = 560,               /* -ffriend-injection */
  OPT_ffunction_cse = 561,                   /* -ffunction-cse */
  OPT_ffunction_sections = 562,              /* -ffunction-sections */
  OPT_fgcse = 563,                           /* -fgcse */
  OPT_fgcse_after_reload = 564,              /* -fgcse-after-reload */
  OPT_fgcse_las = 565,                       /* -fgcse-las */
  OPT_fgcse_lm = 566,                        /* -fgcse-lm */
  OPT_fgcse_sm = 567,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 568,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 569,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 570,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 571,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 572,                     /* -fgo-prefix= */
  OPT_fgraphite = 573,                       /* -fgraphite */
  OPT_fgraphite_identity = 574,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 575,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 576, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 577, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 578,           /* -fhash-synchronization */
  /* OPT_fhelp = 579, */                     /* -fhelp */
  /* OPT_fhelp_ = 580, */                    /* -fhelp= */
  /* OPT_fhonor_std = 581, */                /* -fhonor-std */
  OPT_fhosted = 582,                         /* -fhosted */
  /* OPT_fhuge_objects = 583, */             /* -fhuge-objects */
  OPT_fident = 584,                          /* -fident */
  OPT_fif_conversion = 585,                  /* -fif-conversion */
  OPT_fif_conversion2 = 586,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 587,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 588,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 589,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 590,             /* -fimplicit-templates */
  OPT_findirect_classes = 591,               /* -findirect-classes */
  OPT_findirect_dispatch = 592,              /* -findirect-dispatch */
  OPT_findirect_inlining = 593,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 594,         /* -finhibit-size-directive */
  OPT_finit_character_ = 595,                /* -finit-character= */
  OPT_finit_integer_ = 596,                  /* -finit-integer= */
  OPT_finit_local_zero = 597,                /* -finit-local-zero */
  OPT_finit_logical_ = 598,                  /* -finit-logical= */
  OPT_finit_real_ = 599,                     /* -finit-real= */
  OPT_finline = 600,                         /* -finline */
  OPT_finline_functions = 601,               /* -finline-functions */
  OPT_finline_functions_called_once = 602,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 603, */            /* -finline-limit- */
  OPT_finline_limit_ = 604,                  /* -finline-limit= */
  OPT_finline_small_functions = 605,         /* -finline-small-functions */
  OPT_finput_charset_ = 606,                 /* -finput-charset= */
  OPT_finstrument_functions = 607,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 608,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 609,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 610,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 611,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 612,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 613,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 614,                    /* -fipa-profile */
  OPT_fipa_pta = 615,                        /* -fipa-pta */
  OPT_fipa_pure_const = 616,                 /* -fipa-pure-const */
  OPT_fipa_reference = 617,                  /* -fipa-reference */
  OPT_fipa_sra = 618,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 619,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 620,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 621,              /* -fira-loop-pressure */
  OPT_fira_region_ = 622,                    /* -fira-region= */
  OPT_fira_share_save_slots = 623,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 624,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 625,                   /* -fira-verbose= */
  OPT_fivopts = 626,                         /* -fivopts */
  OPT_fjni = 627,                            /* -fjni */
  OPT_fjump_tables = 628,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 629,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 630,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 631,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 632, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 633,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 634,             /* -fleading-underscore */
  OPT_floop_block = 635,                     /* -floop-block */
  OPT_floop_flatten = 636,                   /* -floop-flatten */
  OPT_floop_interchange = 637,               /* -floop-interchange */
  /* OPT_floop_optimize = 638, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 639,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 640,                /* -floop-strip-mine */
  OPT_flto = 641,                            /* -flto */
  OPT_flto_compression_level_ = 642,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 643,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 644,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 645,             /* -flto-partition=none */
  OPT_flto_report = 646,                     /* -flto-report */
  OPT_flto_ = 647,                           /* -flto= */
  OPT_fltrans = 648,                         /* -fltrans */
  OPT_fltrans_output_list_ = 649,            /* -fltrans-output-list= */
  OPT_fmain_ = 650,                          /* -fmain= */
  OPT_fmath_errno = 651,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 652,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 653,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 654,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 655,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 656,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 657,                     /* -fmem-report */
  OPT_fmerge_all_constants = 658,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 659,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 660,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 661,                /* -fmessage-length= */
  OPT_fmodule_private = 662,                 /* -fmodule-private */
  OPT_fmodulo_sched = 663,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 664,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 665,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 666,                  /* -fms-extensions */
  OPT_fmudflap = 667,                        /* -fmudflap */
  OPT_fmudflapir = 668,                      /* -fmudflapir */
  OPT_fmudflapth = 669,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 670, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 671, */                  /* -fnew-abi */
  OPT_fnext_runtime = 672,                   /* -fnext-runtime */
  OPT_fnil_receivers = 673,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 674,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 675,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 676, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 677,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 678,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 679,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 680,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 681,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 682,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 683,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 684,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 685,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 686,             /* -fomit-frame-pointer */
  OPT_fopenmp = 687,                         /* -fopenmp */
  OPT_foperator_names = 688,                 /* -foperator-names */
  OPT_foptimize_register_move = 689,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 690,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 691,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 692, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 693,              /* -foutput-class-dir= */
  OPT_fpack_derived = 694,                   /* -fpack-derived */
  OPT_fpack_struct = 695,                    /* -fpack-struct */
  OPT_fpack_struct_ = 696,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 697,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 698,              /* -fpcc-struct-return */
  OPT_fpch_deps = 699,                       /* -fpch-deps */
  OPT_fpch_preprocess = 700,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 701,                     /* -fpeel-loops */
  OPT_fpeephole = 702,                       /* -fpeephole */
  OPT_fpeephole2 = 703,                      /* -fpeephole2 */
  OPT_fpermissive = 704,                     /* -fpermissive */
  OPT_fpic = 705,                            /* -fpic */
  OPT_fpie = 706,                            /* -fpie */
  OPT_fplan9_extensions = 707,               /* -fplan9-extensions */
  ...
  OPT_fprofile_use = 722,                    /* -fprofile-use */
  OPT_fprofile_use_ = 723,                   /* -fprofile-use= */
  OPT_fprofile_values = 724,                 /* -fprofile-values */
  OPT_fprotect_parens = 725,                 /* -fprotect-parens */
  OPT_frandom_seed = 726,                    /* -frandom-seed */
  OPT_frandom_seed_ = 727,                   /* -frandom-seed= */
  OPT_frange_check = 728,                    /* -frange-check */
  OPT_frealloc_lhs = 729,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 730,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 731,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 732,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 733,                /* -frecord-marker=8 */
  OPT_frecursive = 734,                      /* -frecursive */
  OPT_freduced_reflection = 735,             /* -freduced-reflection */
  OPT_freg_struct_return = 736,              /* -freg-struct-return */
  OPT_fregmove = 737,                        /* -fregmove */
  OPT_frename_registers = 738,               /* -frename-registers */
  OPT_freorder_blocks = 739,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 740,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 741,              /* -freorder-functions */
  OPT_frepack_arrays = 742,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 743,           /* -freplace-objc-classes */
  OPT_frepo = 744,                           /* -frepo */
  OPT_frequire_return_statement = 745,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 746,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 747, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 748,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 749,                    /* -fresolution= */
  OPT_frounding_math = 750,                  /* -frounding-math */
  OPT_frtti = 751,                           /* -frtti */
  OPT_fsaw_java_file = 752,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 753,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 754,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 755,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 756,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 757,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 758,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 759,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 760,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 761,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 762,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 763,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 764,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 765,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 766,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 767,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 768,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 769,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 770, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 771,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 772,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 773,              /* -fsecond-underscore */
  OPT_fsection_anchors = 774,                /* -fsection-anchors */
  /* OPT_fsee = 775, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 776,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 777,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 778, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 779,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 780,          /* -fselective-scheduling2 */
  OPT_fshort_double = 781,                   /* -fshort-double */
  OPT_fshort_enums = 782,                    /* -fshort-enums */
  OPT_fshort_wchar = 783,                    /* -fshort-wchar */
  OPT_fshow_column = 784,                    /* -fshow-column */
  OPT_fsign_zero = 785,                      /* -fsign-zero */
  OPT_fsignaling_nans = 786,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 787,               /* -fsigned-bitfields */
  OPT_fsigned_char = 788,                    /* -fsigned-char */
  OPT_fsigned_zeros = 789,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 790,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 791,               /* -fsource-filename= */
  OPT_fsource_ = 792,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 793,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 794,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 795,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 796, */                 /* -fsquangle */
  /* OPT_fstack_check = 797, */              /* -fstack-check */
  OPT_fstack_check_ = 798,                   /* -fstack-check= */
  OPT_fstack_limit = 799,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 800,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 801,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 802,                /* -fstack-protector */
  OPT_fstack_protector_all = 803,            /* -fstack-protector-all */
  OPT_fstack_usage = 804,                    /* -fstack-usage */
  OPT_fstats = 805,                          /* -fstats */
  OPT_fstore_check = 806,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 807, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 808,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 809,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 810,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 811, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 812,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 813,                    /* -fsyntax-only */
  OPT_ftabstop_ = 814,                       /* -ftabstop= */
  /* OPT_ftarget_help = 815, */              /* -ftarget-help */
  OPT_ftarget_ = 816,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 817, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 818,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 819,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 820, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 821,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 822,             /* -fthreadsafe-statics */
  OPT_ftime_report = 823,                    /* -ftime-report */
  OPT_ftls_model_ = 824,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 825,               /* -ftoplevel-reorder */
  OPT_ftracer = 826,                         /* -ftracer */
  OPT_ftrapping_math = 827,                  /* -ftrapping-math */
  OPT_ftrapv = 828,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 829,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 830,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 831,                       /* -ftree-ccp */
  OPT_ftree_ch = 832,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 833,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 834,                /* -ftree-copyrename */
  OPT_ftree_cselim = 835,                    /* -ftree-cselim */
  OPT_ftree_dce = 836,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 837,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 838,                       /* -ftree-dse */
  OPT_ftree_forwprop = 839,                  /* -ftree-forwprop */
  OPT_ftree_fre = 840,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 841,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 842,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 843,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 844,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 845,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 846,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 847, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 848,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 849,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 850,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 851,                   /* -ftree-phiprop */
  OPT_ftree_pre = 852,                       /* -ftree-pre */
  OPT_ftree_pta = 853,                       /* -ftree-pta */
  OPT_ftree_reassoc = 854,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 855, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 856,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 857,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 858,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 859,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 860, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 861, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 862,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 863,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 864,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 865,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 866,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 867,                       /* -ftree-vrp */
  OPT_funderscoring = 868,                   /* -funderscoring */
  OPT_funit_at_a_time = 869,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 870,               /* -funroll-all-loops */
  OPT_funroll_loops = 871,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 872,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 873,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 874,             /* -funsigned-bitfields */
  OPT_funsigned_char = 875,                  /* -funsigned-char */
  OPT_funswitch_loops = 876,                 /* -funswitch-loops */
  OPT_funwind_tables = 877,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 878,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 879,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 880,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 881,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 882,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 883,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 884,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 885,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 886,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 887,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 888, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 889,                /* -fvect-cost-model */
  OPT_fverbose_asm = 890,                    /* -fverbose-asm */
  /* OPT_fversion = 891, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 892,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 893,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 894,                    /* -fvisibility= */
  OPT_fvpt = 895,                            /* -fvpt */
  /* OPT_fvtable_gc = 896, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 897, */            /* -fvtable-thunks */
  OPT_fweak = 898,                           /* -fweak */
  OPT_fweb = 899,                            /* -fweb */
  OPT_fwhole_file = 900,                     /* -fwhole-file */
  OPT_fwhole_program = 901,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 902,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 903,              /* -fworking-directory */
  OPT_fwpa = 904,                            /* -fwpa */
  OPT_fwrapv = 905,                          /* -fwrapv */
  /* OPT_fxref = 906, */                     /* -fxref */
  OPT_fzee = 907,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 908,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 909,                      /* -fzero-link */
  OPT_g = 910,                               /* -g */
  OPT_gant = 911,                            /* -gant */
  OPT_gcoff = 912,                           /* -gcoff */
  OPT_gdwarf_ = 913,                         /* -gdwarf- */
  OPT_gen_decls = 914,                       /* -gen-decls */
  OPT_ggdb = 915,                            /* -ggdb */
  OPT_gnat = 916,                            /* -gnat */
  OPT_gnatO = 917,                           /* -gnatO */
  OPT_gno_strict_dwarf = 918,                /* -gno-strict-dwarf */
  OPT_gstabs = 919,                          /* -gstabs */
  OPT_gstabs_ = 920,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 921,                   /* -gstrict-dwarf */
  OPT_gtoggle = 922,                         /* -gtoggle */
  OPT_gvms = 923,                            /* -gvms */
  OPT_gxcoff = 924,                          /* -gxcoff */
  OPT_gxcoff_ = 925,                         /* -gxcoff+ */
  OPT_h = 926,                               /* -h */
  OPT_idirafter = 927,                       /* -idirafter */
  OPT_imacros = 928,                         /* -imacros */
  OPT_imultilib = 929,                       /* -imultilib */
  OPT_include = 930,                         /* -include */
  OPT_iplugindir_ = 931,                     /* -iplugindir= */
  OPT_iprefix = 932,                         /* -iprefix */
  OPT_iquote = 933,                          /* -iquote */
  OPT_isysroot = 934,                        /* -isysroot */
  OPT_isystem = 935,                         /* -isystem */
  OPT_iwithprefix = 936,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 937,               /* -iwithprefixbefore */
  OPT_k8 = 938,                              /* -k8 */
  OPT_l = 939,                               /* -l */
  OPT_lang_asm = 940,                        /* -lang-asm */
  OPT_m128bit_long_double = 941,             /* -m128bit-long-double */
  OPT_m32 = 942,                             /* -m32 */
  OPT_m3dnow = 943,                          /* -m3dnow */
  OPT_m3dnowa = 944,                         /* -m3dnowa */
  OPT_m64 = 945,                             /* -m64 */
  OPT_m80387 = 946,                          /* -m80387 */
  OPT_m8bit_idiv = 947,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 948,              /* -m96bit-long-double */
  OPT_mabi_ = 949,                           /* -mabi= */
  OPT_mabm = 950,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 951,       /* -maccumulate-outgoing-args */
  OPT_maes = 952,                            /* -maes */
  OPT_malign_double = 953,                   /* -malign-double */
  OPT_malign_functions_ = 954,               /* -malign-functions= */
  OPT_malign_jumps_ = 955,                   /* -malign-jumps= */
  OPT_malign_loops_ = 956,                   /* -malign-loops= */
  OPT_malign_stringops = 957,                /* -malign-stringops */
  OPT_mandroid = 958,                        /* -mandroid */
  OPT_march_ = 959,                          /* -march= */
  OPT_masm_ = 960,                           /* -masm= */
  OPT_mavx = 961,                            /* -mavx */
  OPT_mbionic = 962,                         /* -mbionic */
  OPT_mbmi = 963,                            /* -mbmi */
  OPT_mbranch_cost_ = 964,                   /* -mbranch-cost= */
  OPT_mcld = 965,                            /* -mcld */
  OPT_mcmodel_ = 966,                        /* -mcmodel= */
  /* OPT_mcpu_ = 967, */                     /* -mcpu= */
  OPT_mcrc32 = 968,                          /* -mcrc32 */
  OPT_mcx16 = 969,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 970,             /* -mdispatch-scheduler */
  OPT_mf16c = 971,                           /* -mf16c */
  OPT_mfancy_math_387 = 972,                 /* -mfancy-math-387 */
  OPT_mfentry = 973,                         /* -mfentry */
  OPT_mfma = 974,                            /* -mfma */
  OPT_mfma4 = 975,                           /* -mfma4 */
  OPT_mforce_drap = 976,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 977,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 978,                        /* -mfpmath= */
  OPT_mfsgsbase = 979,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 980, */               /* -mfused-madd */
  OPT_mglibc = 981,                          /* -mglibc */
  OPT_mhard_float = 982,                     /* -mhard-float */
  OPT_mieee_fp = 983,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 984,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 985,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 986,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 987, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 988,          /* -mlarge-data-threshold= */
  OPT_mlwp = 989,                            /* -mlwp */
  OPT_mmmx = 990,                            /* -mmmx */
  OPT_mmovbe = 991,                          /* -mmovbe */
  OPT_mms_bitfields = 992,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 993,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 994,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 995,                   /* -mno-push-args */
  OPT_mno_red_zone = 996,                    /* -mno-red-zone */
  OPT_mno_sse4 = 997,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 998,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 999,                             /* -mpc */
  OPT_mpclmul = 1000,                        /* -mpclmul */
  OPT_mpopcnt = 1001,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1002,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1003,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1004,                     /* -mpush-args */
  OPT_mrdrnd = 1005,                         /* -mrdrnd */
  OPT_mrecip = 1006,                         /* -mrecip */
  OPT_mred_zone = 1007,                      /* -mred-zone */
  OPT_mregparm_ = 1008,                      /* -mregparm= */
  OPT_mrtd = 1009,                           /* -mrtd */
  OPT_msahf = 1010,                          /* -msahf */
  OPT_msoft_float = 1011,                    /* -msoft-float */
  OPT_msse = 1012,                           /* -msse */
  OPT_msse2 = 1013,                          /* -msse2 */
  OPT_msse2avx = 1014,                       /* -msse2avx */
  OPT_msse3 = 1015,                          /* -msse3 */
  OPT_msse4 = 1016,                          /* -msse4 */
  OPT_msse4_1 = 1017,                        /* -msse4.1 */
  OPT_msse4_2 = 1018,                        /* -msse4.2 */
  OPT_msse4a = 1019,                         /* -msse4a */
  /* OPT_msse5 = 1020, */                    /* -msse5 */
  OPT_msseregparm = 1021,                    /* -msseregparm */
  OPT_mssse3 = 1022,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1023,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1024,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1025,            /* -mstringop-strategy= */
  OPT_mtbm = 1026,                           /* -mtbm */
  OPT_mtls_dialect_ = 1027,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1028,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1029,                         /* -mtune= */
  OPT_muclibc = 1030,                        /* -muclibc */
  OPT_mveclibabi_ = 1031,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1032,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1033,                    /* -mvzeroupper */
  OPT_mxop = 1034,                           /* -mxop */
  OPT_n = 1035,                              /* -n */
  OPT_no_canonical_prefixes = 1036,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1037,              /* -no-integrated-cpp */
  OPT_nocpp = 1038,                          /* -nocpp */
  OPT_nodefaultlibs = 1039,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1040,                   /* -nostartfiles */
  OPT_nostdinc = 1041,                       /* -nostdinc */
  OPT_nostdinc__ = 1042,                     /* -nostdinc++ */
  OPT_nostdlib = 1043,                       /* -nostdlib */
  OPT_o = 1044,                              /* -o */
  OPT_p = 1045,                              /* -p */
  OPT_pass_exit_codes = 1046,                /* -pass-exit-codes */
  OPT_pedantic = 1047,                       /* -pedantic */
  OPT_pedantic_errors = 1048,                /* -pedantic-errors */
  OPT_pg = 1049,                             /* -pg */
  OPT_pie = 1050,                            /* -pie */
  OPT_pipe = 1051,                           /* -pipe */
  OPT_posix = 1052,                          /* -posix */
  OPT_print_file_name_ = 1053,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1054,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1055,          /* -print-multi-directory */
  OPT_print_multi_lib = 1056,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1057,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1058,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1059,               /* -print-prog-name= */
  OPT_print_search_dirs = 1060,              /* -print-search-dirs */
  OPT_print_sysroot = 1061,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1062,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1063,                        /* -profile */
  OPT_pthread = 1064,                        /* -pthread */
  OPT_quiet = 1065,                          /* -quiet */
  OPT_r = 1066,                              /* -r */
  OPT_rdynamic = 1067,                       /* -rdynamic */
  ...
  OPT_std_f95 = 1093,                        /* -std=f95 */
  OPT_std_gnu = 1094,                        /* -std=gnu */
  OPT_std_gnu__0x = 1095,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1096,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1097,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1098, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1099,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1100,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1101, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1102, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1103,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1104, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1105, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1106,                     /* -std=legacy */
  OPT_symbolic = 1107,                       /* -symbolic */
  OPT_t = 1108,                              /* -t */
  OPT_time = 1109,                           /* -time */
  OPT_time_ = 1110,                          /* -time= */
  OPT_tno_android_cc = 1111,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1112,                 /* -tno-android-ld */
  OPT_traditional = 1113,                    /* -traditional */
  OPT_traditional_cpp = 1114,                /* -traditional-cpp */
  OPT_trigraphs = 1115,                      /* -trigraphs */
  OPT_u = 1116,                              /* -u */
  OPT_undef = 1117,                          /* -undef */
  OPT_v = 1118,                              /* -v */
  OPT_version = 1119,                        /* -version */
  OPT_w = 1120,                              /* -w */
  OPT_wrapper = 1121,                        /* -wrapper */
  OPT_x = 1122,                              /* -x */
  OPT_z = 1123,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
