...
"x86_64-linux-thread-multi-2.6.39-arch" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.39-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
