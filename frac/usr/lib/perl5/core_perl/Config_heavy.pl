...
cf_time='Wed Jun 29 17:15:04 UTC 2011'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
mydomain='.nonet'
myhostname='foutbox'
myuname='linux foutbox 2.6.39-arch #1 smp preempt mon jun 27 21:26:22 cest 2011 x86_64 amd phenom(tm) ii x6 1090t processor authenticamd gnulinux '
n='-n'
need_va_copy='define'
...
phostname='uname -n'
pidtype='pid_t'
plibpth='/lib/x86_64-unknown-linux-gnu/4.6.1 /lib/../lib /usr/lib/x86_64-unknown-linux-gnu/4.6.1 /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
